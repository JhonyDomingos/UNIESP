...
# Inicialize uma lista vazia para armazenar os nomes dos clubes
clubes = []

# Faça um loop para ler os nomes dos clubes
...
# Verifique se o nome está na lista e exiba a mensagem apropriada
